...
const Report = () => {
  ...
  const pageCount = Math.ceil(items.length / postPerPage);
              ...
              <tr>
                ...
                <th>
                  ...
                  <select onChange={(e) => setCompanyName(e.target.value)}>
                    ...
                    <option value="Experts Solutions">Experts Solutions</option>
                    <option value="Matrix Infologics">Matrix Infologics</option>
                  </select>{" "}
                </th>
                {/* <th> Company Name </th> */}
                ...
                <tr>
                  ...
                  <td>
                    <li>
                      ...
                      {
                        items.filter(
                          (applicant) => applicant.jobTitle === "Web Developer"
                        ).length
                      }{" "}
                    </li>
                    <li>
