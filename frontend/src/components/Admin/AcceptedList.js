...
function AcceptedList() {
  ...
  const pageCount = Math.ceil(acceptedList.length / postsPerPage);
      ...
      <div className="rwtables">
        <div className="row">
          ...
          <div className="col-lg-9 col-md-9 col-sm-10 col-10">
            <h1 className="text-center"> Accepted Application List </h1>
            <Link to={"/all-applicant"} className="btn btn-danger m-4"> Back </Link>
